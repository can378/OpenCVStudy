...
img=cv.imread("../source/sign.png",cv.IMREAD_UNCHANGED)
...
plt.imshow(b_dilation,cpma="gray"),plt.xticks([]),plt.yticks([])
plt.show()
...
plt.imshow(b_closing,cmpa="gray"),plt.xticks([]),plt.yticks([])
plt.show()
